...
UObjectStat* UBagComponent::GetItem(int _index)
{
	if (_index > Bag.Num())
	{
		GEngine->AddOnScreenDebugMessage(-1, 5, FColor::Red, "INDEX > BAG SIZE (BAG COMPONENT)");
		return nullptr;
	}
	return Bag[_index];
}

bool UBagComponent::GetBagfreeAsSpace()
{
	return true;
}
